const uiMarkup = `
  <style>
    ...
    .controls__wrapper--scrubber {
      flex-grow: 1;
      padding: 0 5px;
    }

    .controls__scrubber-line {
      position: relative;
      margin-top: 10px;
      border-top: 4px solid rgba(255, 255, 255, 0.35);
    }

    .controls__scrubber-knob {
      position: absolute;
      top: -9px;
      left: 0;
      margin-left: -5px;
  ...
  <div class="controls__wrapper is-visible">
    <div class="controls">
      <div class="controls__control-wrapper">
        <select aria-label="Select show to load" name="load-show" id="load-show">
      ...
      <div class="controls__control-wrapper is-disabled controls__wrapper--scrubber">
        <div class="controls__scrubber-line">
          <div class="controls__scrubber-knob"></div>
        </div>
      </div>
      <div class="controls__control-wrapper is-disabled">
        <select aria-label="Playback Speed" name="playback-speed" id="playback-speed">
...
export const addControls = (containerId) => {
